  ...
  var require_validate = __commonJS({
    "node_modules/validate.js/validate.js"(exports, module) {
      (function(exports2, module2, define2) {
        "use strict";
        var validate2 = function(attributes2, constraints, options2) {
          options2 = v.extend({}, v.options, options2);
          var results = v.runValidations(attributes2, constraints, options2), attr, validator;
        ...
        v.extend(validate2, {
          ...
          runValidations: function(attributes2, constraints, options2) {
            var results = [], attr, validatorName, value, validators, validator, validatorOptions, error2;
            if (v.isDomElement(attributes2) || v.isJqueryElement(attributes2)) {
              attributes2 = v.collectFormValues(attributes2);
            }
            for (attr in constraints) {
              value = v.getDeepObjectValue(attributes2, attr);
              validators = v.result(constraints[attr], value, attributes2, attr, options2, constraints);
              for (validatorName in validators) {
                validator = v.validators[validatorName];
                if (!validator) {
                  error2 = v.format("Unknown validator %{name}", { name: validatorName });
                  throw new Error(error2);
                }
                validatorOptions = validators[validatorName];
                validatorOptions = v.result(validatorOptions, value, attributes2, attr, options2, constraints);
                if (!validatorOptions) {
                  continue;
                }
                results.push({
          ...
          processValidationResults: function(errors, options2) {
            ...
            if (typeof v.formatters[format2] === "function") {
              errors = v.formatters[format2](errors);
            } else {
              throw new Error(v.format("Unknown format %{format}", options2));
            }
            return v.isEmpty(errors) ? void 0 : errors;
          },
          async: function(attributes2, constraints, options2) {
            ...
            if (options2.cleanAttributes !== false) {
              attributes2 = v.cleanAttributes(attributes2, constraints);
            }
            var results = v.runValidations(attributes2, constraints, options2);
            return new v.Promise(function(resolve, reject) {
              v.waitForResults(results).then(function() {
                var errors = v.processValidationResults(results, options2);
                if (errors) {
                  reject(new WrapErrors(errors, options2, attributes2, constraints));
                } else {
                  resolve(attributes2);
                }
              }, function(err) {
          ...
          waitForResults: function(results) {
            return results.reduce(function(memo, result) {
              ...
              return memo.then(function() {
                return result.error.then(function(error2) {
          ...
          forEachKeyInKeypath: function(object2, keypath, callback) {
              ...
              switch (keypath[i]) {
                case ".":
                  if (escape) {
                    ...
                    object2 = callback(object2, key, false);
                    key = "";
                  }
                  break;
                case "\\":
            ...
            return callback(object2, key, true);
          },
          ...
          collectFormValues: function(form, options2) {
            var values = {}, i, j, input2, inputs, option, value;
            ...
            for (i = 0; i < inputs.length; ++i) {
              input2 = inputs.item(i);
              if (v.isDefined(input2.getAttribute("data-ignored"))) {
                continue;
              }
              var name = input2.name.replace(/\./g, "\\\\.");
              value = v.sanitizeFormValue(input2.value, options2);
              if (input2.type === "number") {
                value = value ? +value : null;
              } else if (input2.type === "checkbox") {
                if (input2.attributes.value) {
                  if (!input2.checked) {
            ...
            for (i = 0; i < inputs.length; ++i) {
              ...
              if (input2.multiple) {
                value = [];
                for (j in input2.options) {
                  option = input2.options[j];
                  if (option && option.selected) {
                    value.push(v.sanitizeFormValue(option.value, options2));
                  }
                }
              } else {
                var _val = typeof input2.options[input2.selectedIndex] !== "undefined" ? input2.options[input2.selectedIndex].value : "";
                value = v.sanitizeFormValue(_val, options2);
              }
              values[input2.name] = value;
            }
            return values;
          },
          ...
          pruneEmptyErrors: function(errors) {
            return errors.filter(function(error2) {
              return !v.isEmpty(error2.error);
            });
          },
          expandMultipleErrors: function(errors) {
            var ret = [];
            errors.forEach(function(error2) {
              if (v.isArray(error2.error)) {
                error2.error.forEach(function(msg) {
                  ret.push(v.extend({}, error2, { error: msg }));
                });
              } else {
                ret.push(error2);
              }
          ...
          convertErrorMessages: function(errors, options2) {
            ...
            errors.forEach(function(errorInfo) {
              ...
              if (!v.isString(error2)) {
                ret.push(errorInfo);
                return;
              }
              if (error2[0] === "^") {
                error2 = error2.slice(1);
              } else if (options2.fullMessages !== false) {
                error2 = v.capitalize(prettify(errorInfo.attribute)) + " " + error2;
              }
              error2 = error2.replace(/\\\^/g, "^");
              error2 = v.format(error2, {
                value: v.stringifyValue(errorInfo.value, options2)
              });
              ret.push(v.extend({}, errorInfo, { error: error2 }));
            });
            return ret;
          },
          groupErrorsByAttribute: function(errors) {
            var ret = {};
            errors.forEach(function(error2) {
              var list = ret[error2.attribute];
              if (list) {
                list.push(error2);
              } else {
                ret[error2.attribute] = [error2];
              }
            });
            return ret;
          },
          ...
          cleanAttributes: function(attributes2, whitelist) {
            ...
            function cleanRecursive(attributes3, whitelist2) {
              if (!v.isObject(attributes3)) {
                return attributes3;
              }
              var ret = v.extend({}, attributes3), w, attribute;
            ...
            if (!v.isObject(whitelist) || !v.isObject(attributes2)) {
              return {};
            }
            whitelist = buildObjectWhitelist(whitelist);
            return cleanRecursive(attributes2, whitelist);
          },
        ...
        validate2.validators = {
          ...
          numericality: function(value, options2, attribute, attributes2, globalOptions) {
            if (!v.isDefined(value)) {
              return;
            }
            options2 = v.extend({}, this.options, options2);
          ...
          equality: function(value, options2, attribute, attributes2, globalOptions) {
            if (!v.isDefined(value)) {
              return;
            }
            ...
            var otherValue = v.getDeepObjectValue(attributes2, options2.attribute), comparator = options2.comparator || function(v1, v2) {
              return v1 === v2;
            }, prettify = options2.prettify || globalOptions && globalOptions.prettify || v.prettify;
            if (!comparator(value, otherValue, options2, attribute, attributes2)) {
          ...
          type: v.extend(function(value, originalOptions, attribute, attributes2, globalOptions) {
            ...
            if (!check(value, options2, attribute, attributes2, globalOptions)) {
              ...
              if (v.isFunction(message)) {
                message = message(value, originalOptions, attribute, attributes2, globalOptions);
              }
...
%o`, message, error2, detail);
  ...
  var image_loader_controller_default = class extends Controller {
    connect() {
    }
    triggerUpload(event) {
      event.preventDefault();
    ...
    handleChange(event) {
      ...
      fileReader.readAsDataURL(input2.files[0]);
    }
  };
  __publicField(image_loader_controller_default, "targets", ["imageContainer", "input", "output"]);

  // app/javascript/controllers/validate_controller.js
  var import_validate = __toESM(require_validate());
  var validate_controller_default = class extends Controller {
    initialize() {
      this._constrains = {};
    }
    connect() {
    ...
    disconnect() {
      document.querySelectorAll('div[id$="_feedback"]').forEach((element) => element.parentNode.removeChild(element));
    }
    ...
    handleChange(e) {
      ...
      let errors = (0, import_validate.default)(field, constrains);
      if (errors) {
    ...
    handleForm(e) {
      e.preventDefault();
      let errors = (0, import_validate.default)(this.formTarget, this._constrains);
      if (errors) {
        this.displayErrors(errors);
      } else {
        let inputTags = this.inputTargets.map((input2) => input2.name);
        this.removeErrors(inputTags);
  ...
  __publicField(validate_controller_default, "targets", ["form", "input"]);
  __publicField(validate_controller_default, "values", { status: Boolean });

  // app/javascript/controllers/index.js
  application.register("image-loader", image_loader_controller_default);
  application.register("validate", validate_controller_default);
  ...
  // app/javascript/utilities/color_picker.js
  ...
  var ColorPicker = class {
    ...
    insertColorPickerButton() {
      this.element.toolbarElement.querySelector("[data-trix-button-group=text-tools").insertAdjacentHTML("beforeend", this.colorPickerButton);
    }
    insertColorPickerDialog() {
      this.element.toolbarElement.querySelector("[data-trix-dialogs").insertAdjacentHTML("beforeend", this.colorPickerDialog);
    }
